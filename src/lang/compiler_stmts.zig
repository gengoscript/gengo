...
const FuncInfo = _cc.FuncInfo;
const AssignTarget = _cc.AssignTarget;
const AssignTargetStep = _cc.AssignTargetStep;
const MaxSwitchJumps = _cc.MaxSwitchJumps;
const MultiAssignValueScratch = _cc.MultiAssignValueScratch;
const FieldTypeAlt = _cc.FieldTypeAlt;
const FieldTypeSpec = _cc.FieldTypeSpec;
const NamedTypeBase = _cc.NamedTypeBase;
const MaxScopes = _cc.MaxScopes;
