...
const _cc = @import("compiler_common.zig");
const Compiler = _cc.Compiler;
const chunk = _cc.chunk;
const Op = _cc.Op;
const common = _cc.common;
const heap = _cc.heap;
const token = _cc.token;
const value_mod = _cc.value_mod;
const ct = _cc.ct;
const MaxLocals = _cc.MaxLocals;
const FieldTypeSpec = _cc.FieldTypeSpec;
const StructFieldSpec = _cc.StructFieldSpec;
const FieldTypeAlt = _cc.FieldTypeAlt;
const Token = _cc.Token;
const MaxTypeAlts = _cc.MaxTypeAlts;
const NamedTypeObj = _cc.NamedTypeObj;
const Object = _cc.Object;
const InterfaceMethodSpec = _cc.InterfaceMethodSpec;
const VariantArmSpec = _cc.VariantArmSpec;
const TypeCheck = _cc.TypeCheck;
const NamedTypeBase = _cc.NamedTypeBase;
const VariantTypeObj = _cc.VariantTypeObj;
const StructTypeObj = _cc.StructTypeObj;
const InterfaceTypeObj = _cc.InterfaceTypeObj;
